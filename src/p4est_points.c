                  ...
                  size_t data_size, p4est_init_t init_fn, void *user_pointer)
{
  ...
  p4est->global_first_position =
    P4EST_SHMEM_ALLOC (p4est_quadrant_t, num_procs + 1, p4est->mpicomm);
  if (sc_shmem_write_start (p4est->global_first_position, p4est->mpicomm)) {
    memset (p4est->global_first_position, 0,
  ...
  p4est->global_first_quadrant =
    P4EST_SHMEM_ALLOC (p4est_gloidx_t, num_procs + 1, p4est->mpicomm);
